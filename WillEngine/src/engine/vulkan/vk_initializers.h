...
VkImageCreateInfo cubemap_create_info(VkFormat format, VkImageUsageFlags usageFlags, VkExtent3D extent);
VkImageViewCreateInfo imageview_create_info(VkFormat format, VkImage image, VkImageAspectFlags aspectFlags);
VkImageViewCreateInfo cubemapview_create_info(VkFormat format, VkImage image, VkImageAspectFlags aspectFlags);
